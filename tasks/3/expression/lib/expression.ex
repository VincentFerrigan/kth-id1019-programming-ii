defmodule Expression do
  ...
  @doc """
  Evaluate given expression based on the provided environment.
  ...
  # Perform addition between two expressions, handling both integers and rational numbers
  ...
  # Perform subtraction between two expressions, handling both integers and rational numbers
  ...
  # Perform division between two expressions, handling both integers and rational numbers.
  # Raise an ArgumentError if an attempt is made to divide by zero.
