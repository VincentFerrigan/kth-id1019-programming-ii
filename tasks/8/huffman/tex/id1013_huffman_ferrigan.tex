...
\href{https://github.com/VincentFerrigan/kth-id1019-programming-ii/tree/main/tasks/8/huffman/test/huffman_test.exs}{tests (test/huffman\_test.exs)}, 
and 
...
\noindent 
The \textbf{first part} builds the Hoffman-tree. 
...
\noindent 
The function \mintinline{elixir}{construct_tree/1} builds the Huffman tree from the priority queue.
